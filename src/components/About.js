        ...
        <>
            ...
            <div className='About-bi2' style={{ marginTop: "100PX" }}>
                ...
                <div className='about-bi-flex4'>
                    ...
                    <p style={{ color: "#737373", width: "80%", fontSize: "20px", margin: "auto", textAlign: "justify" }}>
                        ...
                        Our courses are curated and taught by industry experts who bring real-world insights and practical experience to the learning process. With CareerclassNameroom, you'll be learning directly from professionals who have successfully navigated the challenges of their respective fields.
                    </p>
            ...
            <div className='About-bi2' style={{ marginTop: "100PX" }}>
                <div className='about-bi-flex5'>
                    <p style={{ color: "#737373", width: "80%", fontSize: "20px", margin: "auto", textAlign: "justify" }}>
                        ...
                        At CareerclassNameroom, learning doesn't end with a single course. We foster a culture of continuous learning and provide access to an ever-expanding library of resources to support your professional growth throughout your career journey.</p>
                </div>
                <div className='about-bi-flex6'>
                    <img width="100%" height="200px" src={About3}></img>
            ...
            <div className='About-bi' style={{ marginTop: "140PX" }}>
                <div className='about-bi-flex1'>
                    ...
                    <p style={{ color: "#737373", width: "80%", fontSize: "20px", margin: "auto", textAlign: "justify" }}>
                        We envision a world where individuals have the confidence and skills to pursue their dream careers and shape a brighter future for themselves. Through CareerclassNameroom, we aim to bridge the gap between education and industry needs, empowering learners to become top-notch professionals and contributing positively to their organizations and society at large.
                    </p>
            ...
            <div className='about-enroll-sec'>
                <div style={{ width: "90%", margin: "auto", position: "relative" }}>
                    ...
                    <p style={{ fontSize: "20px" }}>Whether you're just starting your career or seeking to take it to new heights, CareerclassNameroom is here to be your partner in success. Take the first step towards transforming your career and unlocking your true potential by enrolling in one of our trans formative courses.
